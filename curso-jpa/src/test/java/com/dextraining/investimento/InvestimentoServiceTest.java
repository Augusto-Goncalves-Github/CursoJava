...
public class InvestimentoServiceTest {
	...
	@Test
	public void buscarTodosMaiorMilTeste(){
		InvestimentoService investimentoService = new InvestimentoService();
		...
		List<Investimento> invest = investimentoService.buscarTodosMaiorMil();
		
		for (Investimento investimento : invest) {
			Assert.assertTrue((investimento.getValor() >= 1000 && investimento.getRendimentoMensal() > 0.25));
		}
	}	

	@Test
	public void buscarTodosComLikeTeste(){
		InvestimentoService investimentoService = new InvestimentoService();
		...
		List<Investimento> invest = investimentoService.buscarTodosComLike("Selic");
		
		for (Investimento investimento : invest) {
			Assert.assertTrue((investimento.getDescricao().toUpperCase().contains("Selic".toUpperCase())));
		}
	}	
}
